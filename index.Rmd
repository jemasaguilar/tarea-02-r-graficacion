...
ca_c19 <- melt(ca_covid19) 

ggplot(ca_c19, aes(fill=variable, y=value, x=pais)) + 
    geom_bar(position="dodge", stat="identity")+ggtitle("Variables de casos COVID-19 agrupadas (Centroamérica y DOM)") +
    xlab("País") + 
    ylab("Casos")
```
